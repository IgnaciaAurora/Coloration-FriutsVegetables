...
training_set = train_datagen.flow_from_directory('C:/Users/ignac/OneDrive/Escritorio/Ignacia/Redes Neuronales/Redes neuronales/deeplearning-az-master/datasets/Part 2 - Convolutional Neural Networks (CNN)/dataset/training_set',
                                                 target_size = (64, 64),
                                                 batch_size = 32, #Lotes de 32 imagenes
                                                 class_mode = 'binary') #Yo se que tengo dos clases

test_set = test_datagen.flow_from_directory('C:/Users/ignac/OneDrive/Escritorio/Ignacia/Redes Neuronales/Redes neuronales/deeplearning-az-master/datasets/Part 2 - Convolutional Neural Networks (CNN)/dataset/test_set',
                                            target_size = (64, 64),#tama;o de carga
                                            batch_size = 32,#tama;o de lotes de imagenes
                                            class_mode = 'binary')

classifier.fit_generator(training_set,
                         steps_per_epoch = 250,#cuantas muestras tiene que tomar en un epoch completo
                         epochs = 20,#cantidad de epoch q le dedicamos a la fase de entrenamiento
                         validation_data = test_set,
                         validation_steps = 1000)

import numpy as np
from keras.preprocessing import image
test_image = image.load_img('C:/Users/ignac/OneDrive/Escritorio/Ignacia/Redes Neuronales/Redes neuronales/deeplearning-az-master/datasets/Part 2 - Convolutional Neural Networks (CNN)/dataset/single_prediction/cat_or_dog_2.jpg', target_size = (64, 64))
